...
const styles = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Banner */
  .td-banner {
    background: #111827; border-radius: 20px; padding: 28px 32px;
  ...
  .td-class-btn {
    ...
    transition:all 0.18s ease; animation:fadeUp 0.3s ease both;
  }
  .td-class-btn:hover { border-color:#d1d5db; background:#fafafa; transform:translateX(-2px); }
  .td-class-btn.active {
    background:#111827; border-color:#111827;
    transform:translateX(-2px); box-shadow:0 4px 14px rgba(17,24,39,0.2);
  }
  .td-class-icon {
  ...
  .td-badge {
    ...
    background:#f4f5f7; padding:2px 8px; border-radius:99px; border:1px solid #e5e7eb;
  }
  .td-students-list {
  ...
  .td-student-row {
    ...
    transition:background 0.15s; animation:fadeUp 0.25s ease both;
  }
  ...
  .td-textarea {
    ...
    padding:10px 13px; font-size:14px; font-family:Tajawal,sans-serif;
    resize:none; outline:none; color:#111827; background:#fafafa;
  ...
  .td-post-btn:active:not(:disabled) { transform:translateY(0) scale(0.98); }
  ...
  .td-ann-empty {
    background:white; border:1px solid #e5e7eb; border-radius:16px; padding:44px;
  ...
  .td-ann-item {
    background:white; border:1px solid #e5e7eb; border-radius:14px;
    padding:15px 16px; display:flex; align-items:flex-start; gap:12px;
    animation:fadeUp 0.3s ease both; transition:border-color 0.15s, box-shadow 0.15s;
  }
  ...
  .td-ann-av {
    ...
    background:#111827; display:flex; align-items:center; justify-content:center;
    font-size:8.5px; font-weight:900; color:white;
  }
  ...
  /* Empty state */
  .td-empty-state {
    background:white; border:1px solid #e5e7eb; border-radius:20px; padding:60px;
