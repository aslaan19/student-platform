        ...
        <>
          ...
          <div className="rb-stats-row">
            ...
            <div className="rb-stat-card">
              ...
              <div className="rb-stat-label">الوحدات</div>
            </div>
            <div className="rb-stat-card">
...
:root {
  ...
  --r: 10px;
  --r2: 16px;
  --shadow: 0 1px 3px rgba(6,36,25,0.07), 0 4px 14px rgba(6,36,25,0.05);
}
...
.rb-page-title { font-size: 22px; font-weight: 800; color: var(--ink); letter-spacing: -0.3px; }
.rb-page-sub { font-size: 13px; color: var(--ink-3); margin-top: 3px; font-weight: 500; }
...
.rb-stat-num { font-size: 30px; font-weight: 800; color: var(--green-500); line-height: 1; }
.rb-stat-label { font-size: 12.5px; color: var(--ink-3); margin-top: 4px; font-weight: 600; }
...
.rb-stage-toggle {
  display: flex; align-items: center; gap: 10px;
  flex: 1; background: none; border: none; cursor: pointer; text-align: right;
}
.rb-stage-badge {
...
.rb-stage-name { font-size: 14.5px; font-weight: 700; color: var(--ink); flex: 1; }
.rb-stage-meta {
  font-size: 11.5px; color: var(--ink-3);
  background: var(--surface-3); padding: 3px 10px; border-radius: 99px;
  font-weight: 600;
}
.rb-chevron { font-size: 10px; color: var(--ink-3); transition: transform 0.2s; }
.rb-chevron.open { transform: rotate(180deg); }
.rb-stage-body { padding: 16px 18px; display: flex; flex-direction: column; gap: 10px; }
...
.rb-module-dot { width: 7px; height: 7px; border-radius: 50%; background: var(--green-200); flex-shrink: 0; }
.rb-module-name { font-size: 13.5px; font-weight: 700; color: var(--ink-2); flex: 1; }
.rb-q-pill {
...
.rb-empty-small { font-size: 12.5px; color: var(--ink-3); text-align: center; padding: 12px 0; }
...
.rb-q-index { font-size: 11px; font-weight: 800; color: var(--green-500); min-width: 18px; padding-top: 2px; }
...
.rb-tag-mcq { background: #eff6ff; color: #1d6cbf; }
.rb-tag-tf { background: var(--green-50); color: var(--green-600); }
.rb-tag-answer { background: var(--green-50); color: var(--green-600); border: 1px solid var(--green-100); }
...
.rb-icon-btn {
  ...
  font-size: 11.5px; color: var(--ink-3); transition: all 0.12s;
  font-family: 'Cairo', sans-serif;
}
.rb-icon-btn:hover { background: var(--surface-3); color: var(--ink); }
.rb-icon-btn.danger:hover { background: #fef2f2; color: #c0392b; }
...
.rb-add-q-btn {
  ...
  background: none; border-radius: 8px; padding: 9px;
  font-size: 12.5px; color: var(--green-500); cursor: pointer;
  font-family: 'Cairo', sans-serif; font-weight: 600;
  transition: all 0.15s;
}
.rb-add-q-btn:hover { border-color: var(--green-500); background: var(--green-50); }
...
.rb-input {
  ...
  padding: 9px 13px;
  font-size: 13.5px; font-family: 'Cairo', sans-serif; color: var(--ink);
  outline: none; background: var(--surface); transition: border-color 0.15s;
}
.rb-input:focus { border-color: var(--green-500); box-shadow: 0 0 0 3px rgba(26,122,74,0.08); }
...
.rb-btn-primary:hover:not(:disabled) { background: var(--green-600); }
...
.rb-btn-ghost {
  ...
  font-family: 'Cairo', sans-serif; white-space: nowrap; transition: all 0.15s;
}
.rb-btn-ghost:hover { border-color: var(--green-500); color: var(--green-500); }
...
.rb-btn-danger-sm:hover { background: #fef2f2; }
...
.rb-empty-title { font-size: 18px; font-weight: 800; color: var(--ink); }
.rb-empty-sub { font-size: 13px; color: var(--ink-3); }
...
.rb-modal {
  ...
  box-shadow: 0 20px 60px rgba(6,36,25,0.18);
...
.rb-modal-title { font-size: 17px; font-weight: 800; color: var(--ink); }
.rb-close-btn {
  background: none; border: none; cursor: pointer;
  color: var(--ink-3); font-size: 17px; padding: 4px 6px;
  border-radius: 7px; line-height: 1; transition: all 0.12s;
}
.rb-close-btn:hover { background: var(--surface-3); color: var(--ink); }
...
.rb-label-hint { font-size: 11px; color: var(--ink-3); font-weight: 400; text-transform: none; }
.rb-type-row { display: flex; gap: 8px; }
.rb-type-btn {
  flex: 1; padding: 10px; border: 1.5px solid var(--border-2);
  border-radius: var(--r); font-size: 13px; font-weight: 600; cursor: pointer;
  background: var(--surface); color: var(--ink-2);
  font-family: 'Cairo', sans-serif; transition: all 0.15s;
}
.rb-type-btn.active { background: var(--green-50); color: var(--green-600); border-color: var(--green-500); }
.rb-textarea {
  width: 100%; border: 1px solid var(--border-2); border-radius: var(--r);
  padding: 10px 13px; font-family: 'Cairo', sans-serif; font-size: 13.5px;
  color: var(--ink); outline: none; resize: vertical; line-height: 1.6;
  background: var(--surface); transition: border-color 0.15s;
}
.rb-textarea:focus { border-color: var(--green-500); box-shadow: 0 0 0 3px rgba(26,122,74,0.08); }
...
.rb-opt-radio.sel { border-color: var(--green-500); background: var(--green-500); }
.rb-opt-radio.sel::after {
...
.rb-opt-input {
  flex: 1; border: 1px solid var(--border-2); border-radius: var(--r);
  padding: 9px 12px; font-family: 'Cairo', sans-serif;
  font-size: 13.5px; color: var(--ink); outline: none;
  background: var(--surface); transition: all 0.15s;
}
.rb-opt-input:focus { border-color: var(--green-500); }
.rb-opt-input.correct { border-color: var(--green-500); background: var(--green-50); }

/* ── TF ── */
.rb-tf-row { display: flex; gap: 10px; }
.rb-tf-btn {
  flex: 1; padding: 12px; border: 1.5px solid var(--border-2);
  border-radius: var(--r); font-size: 14px; font-weight: 700; cursor: pointer;
  background: var(--surface); font-family: 'Cairo', sans-serif;
  transition: all 0.15s; display: flex; align-items: center; justify-content: center; gap: 7px;
  color: var(--ink-3);
}
.rb-tf-btn.true-btn.sel { background: var(--green-50); color: var(--green-600); border-color: var(--green-500); }
.rb-tf-btn.false-btn.sel { background: #fef2f2; color: #b91c1c; border-color: #fecaca; }

/* ── Error ── */
.rb-error {
  background: #fef2f2; border: 1px solid #fecaca;
  color: #b91c1c; font-size: 12.5px; padding: 9px 13px;
