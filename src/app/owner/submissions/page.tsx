    ...
    <div className="sub-page" dir="rtl">
      <div className="sub-header">
        <div className="sub-header-text">
          <h1 className="sub-title">الإجابات المقدَّمة</h1>
          <p className="sub-sub">
            إجابات اختبار القبول بانتظار المراجعة أو التي تمت مراجعتها
          </p>
        </div>
        {pending > 0 && (
          ...
          {submissions.map((s) => (
            ...
            >
              ...
              <div className="sub-right">
                ...
                <div
                  className={`status-chip ${s.review_status === "REVIEWED" ? "reviewed" : "pending"}`}
                >
                  {s.review_status === "REVIEWED"
                    ? "تمت المراجعة"
                    : "في الانتظار"}
      ...
      <style>{`
        ...
        .sub-header { display:flex; align-items:flex-start; justify-content:space-between; gap:12px; flex-wrap:wrap; padding-bottom:20px; border-bottom:1px solid var(--border); }
        ...
        .pending-alert { display:flex; align-items:center; gap:7px; background:var(--warning-bg); border:1px solid rgba(180,83,9,0.2); color:var(--warning); font-size:12.5px; font-weight:800; padding:8px 16px; border-radius:20px; }
        ...
        .filter-btn { background:var(--surface); border:1px solid var(--border); color:var(--text2); padding:8px 16px; border-radius:8px; font-size:13px; font-weight:600; cursor:pointer; transition:all 0.15s; font-family:'Cairo',sans-serif; box-shadow:var(--shadow-sm); }
        ...
        .sub-row { display:flex; align-items:center; gap:14px; background:var(--surface); border:1px solid var(--border); border-radius:var(--radius); padding:15px 18px; text-decoration:none; color:var(--text); transition:border-color 0.15s,box-shadow 0.15s; box-shadow:var(--shadow-sm); }
        .sub-row:hover { border-color:var(--accent); box-shadow:var(--shadow); }
        .sub-avatar { width:40px; height:40px; border-radius:10px; flex-shrink:0; background:linear-gradient(145deg,var(--accent),#2563c4); display:flex; align-items:center; justify-content:center; font-size:16px; font-weight:800; color:white; }
